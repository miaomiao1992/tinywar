...
use crate::core::constants::{UNIT_DEFAULT_SIZE, UNIT_SCALE};
...
impl UnitName {
    pub fn description(&self) -> &'static str {
        match self {
            ...
            UnitName::Gnoll => {
                "A scavengy creature that attacks by hurling bones at its enemies. Gnolls have \
                 lower range than archers and sharks, but deal more damage."
            },
            UnitName::Gnome => {
            ...
            UnitName::Shaman => {
                "Shamans are powerful goblin mages who casts devastating spells from a safe \
                distance. Shamans deal massive magic damage but are easy to kill in close combat."
            },
            UnitName::Shark => {
            ...
            UnitName::Troll => {
                "Trolls are giant, unstoppable titans that charge with a giant hammer, \
                dealing massive damage to anyone in its path."
            },
            UnitName::Turtle => {
    ...
    pub fn world_size(&self) -> f32 {
        UNIT_SCALE
            * match self {
                UnitName::Troll | UnitName::Minotaur | UnitName::Turtle => self.size(),
                _ => UNIT_DEFAULT_SIZE,
            }
    }
    ...
    pub fn frames(&self, action: Action) -> u32 {
        match self {
            ...
            UnitName::Gnoll => match action {
                Action::Idle => 6,
                Action::Run => 8,
                Action::Attack(_) => 6, // Skip last 2 frames to spawn bone at end of animation
                _ => 0,
            },
    ...
    pub fn spawn_duration(&self) -> u64 {
        match self {
            ...
            UnitName::Minotaur => 7900,
            UnitName::Shaman => 7000,
            UnitName::Shark => 3500,
            UnitName::Skull => 800,
            UnitName::Snake => 500,
            UnitName::Spider => 2500,
            UnitName::Troll => 10000,
            UnitName::Turtle => 6500,
        }
    }
    ...
    pub fn projectile(&self) -> Option<Projectile> {
        match self {
            ...
            UnitName::Gnoll => Some(Projectile::Bone),
            UnitName::Shaman => Some(Projectile::Magic),
